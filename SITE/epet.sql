...
CREATE TABLE Animal(id INTEGER PRIMARY KEY AUTOINCREMENT,name TEXT NOT NULL,type INTEGER NOT NULL,state INTEGER NOT NULL,y0 FLOAT NOT NULL,x0 FLOAT NOT NULL,secuperim INTEGER NOT NULL,owner INTEGER NOT NULL,FOREIGN KEY (secuperim) REFERENCES Perimeter(id),FOREIGN KEY (owner) REFERENCES User(id));
...
INSERT INTO Animal(name,type,state,y0,x0,secuperim,owner) VALUES ("tokyo","chien",0,48.8566,2.3522,1,1);
INSERT INTO Animal(name,type,state,y0,x0,secuperim,owner) VALUES ("chanel","chat",1,48.8765,2.3783,1,1);
INSERT INTO Animal(name,type,state,y0,x0,secuperim,owner) VALUES ("franklin","chien",1,2,3,2,2);
