    ...
    Serial.println("Accelero mesure");
     mma.getEvent(&event);
      ...
      if (minutes_acc == 15 )
      {
        ...
        {
          Serial.println(i);
          Serial.print(" mouv sur X : ");Serial.println(mouvX[i]);
          Serial.print(" mouv sur Y : ");Serial.println(mouvY[i]);
        }
        minutes_acc = 0 ;
       }
...
int testCas(){
  ...
  if(temp1 < 3798 or temp1 > 3902 or temp2 < 3798 or temp2 > 3902){
    Serial.print("countx ");Serial.println(countX);
    Serial.print("county ");Serial.println(countY);
    if((Xaddseuil + Yaddseuil) < (countX + countY)){
