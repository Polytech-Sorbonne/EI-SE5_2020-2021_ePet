...
CREATE TABLE Perimeter(id INTEGER PRIMARY KEY AUTOINCREMENT,x0 FLOAT NOT NULL,y0 FLOAT NOT NULL,x1 FLOAT NOT NULL,y1 FLOAT NOT NULL,x2 FLOAT NOT NULL,y2 FLOAT NOT NULL,x3 FLOAT NOT NULL,y3 FLOAT NOT NULL);
...
INSERT INTO Perimeter(x0,y0,x1,y1,x2,y2,x3,y3) VALUES (48.8566,2.3522,48.8852,2.3856,48.8354,2.4055,48.9056,2.4044);
